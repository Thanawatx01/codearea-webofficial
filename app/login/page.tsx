  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F] text-white flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-white/5 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl border border-white/10 p-8 sm:p-12 relative z-10">
        ...
        <p className="text-white/40 text-center text-sm mb-10">Log in to your CodeArea account</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between px-1">
              <label className="text-xs font-semibold text-white/50 uppercase tracking-widest block">Password</label>
              <Link href="#" className="text-[10px] font-bold text-primary hover:text-primary-hover uppercase tracking-widest">Forgot?</Link>
            </div>
            <ThemedInput
